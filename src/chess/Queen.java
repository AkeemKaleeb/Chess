...
public class Queen extends Piece {
    ...
    public Queen(Chess.Player owner, Position position, Board board) {
        super(owner, position, owner == Chess.Player.white ? ReturnPiece.PieceType.WQ : ReturnPiece.PieceType.BQ, board);
    }
